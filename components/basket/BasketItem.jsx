...
function handleRemoveProduct(product) {
  ...
  return (
    ...
    <td>{price}</td>
    <td><select value={quantity} onChange={(e)=>handleUpdateBasket(product,e.target.value)}>
    ...
    <td><button onClick={()=>handleRemoveProduct(product)} type="button" className="btn btn-outline-danger">X</button></td>
  </tr>
